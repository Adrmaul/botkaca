...
COMMAND = Config({
    ...
    'HELP' : 'help3',
    'LEECH' : 'mirror3',
    'CANCEL_LEECH' : 'cancel3',
    'LEECH_LIST' : 'list3',
    'UPLOAD_AS_DOC' : 'upload_doc3',
    'UPLOAD_AS_ZIP' : 'upload_zip3',
    'SET_THUMBNAIL' : 'set_thumbnail3',
    'RESET_THUMBNAIL' : 'reset_thumbnail3',
    'SET_TRACKER' : 'set_tracker3'
}, 'COMMAND_')
